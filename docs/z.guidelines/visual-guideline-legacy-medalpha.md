# MedAlpha - Visual Guideline (Legacy)

This file preserves the previous `docs/z.guidelines/visual-guideline.md` content for reference.
For DocliQ (Brand Guide 2025) use `docs/z.guidelines/visual-guideline.md` and `docs/z.guidelines/docliq-tokens.json`.
