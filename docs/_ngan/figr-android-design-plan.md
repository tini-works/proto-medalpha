...
# MedAlpha Connect — Android MVP Design Plan
...
- **Primary:** #0C3D91 (CTAs, headers, links)
- **Primary Light:** #1E5BB8 (hover states)
- **Accent (dmYellow):** #FFC603 (time slots, highlights)
- **Success:** #2E7D32 (confirmations, open status)
- **Background:** #F5F7FA (screen base)
...
- **German-first:** All UI text in German (Sie form)
